...
class ReinRate:
    ...
    def train_reinforce(self, env: ReinRateEnv, act: ReinRateAct) -> ReinRateAct:
        ...
        # use only snr for simplicity, add cw and fer for richer input.
        ...
        reward = self.reward_tpt_gain(self.last_state['throughput'])
        self.agent.rewards.append(reward)
        self.agent.update()
...
if __name__ == '__main__':
    ...
    mempool_key = 1346 # memory pool key, arbitrary integer large than 1006
    ...
    c = ReinRate(memblock_key,model_name='best.pt', retrain=False)
    iters_count = 0
